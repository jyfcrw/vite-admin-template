<template>
  <div style="display: inline-block; margin: 0 10px" v-if="errorLogs.length">
    ...
    <el-dialog title="Error Log" :visible.sync="dialogTableVisible" width="80%" style="text-align: left">
...
export default {
  ...
  computed: {
    errorLogs () {
      return this.$store.state.errLog.logs
    }
  }
}
</script>
